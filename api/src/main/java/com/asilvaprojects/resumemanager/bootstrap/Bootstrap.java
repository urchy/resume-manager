...
public class Bootstrap implements CommandLineRunner {
    ...
    private Resume createResume() {
        ...
        return new ResumeBuilder()
                ...
                .buildExperince("1","Developer & Scrum Master", "As a Senior Software Engineer I'm responsable for implement our clients requirements, helping young members, training them, interview new members.", LocalDate.of(2019, 11,1), LocalDate.now())
                .buildSkill("1","Java", 4)
                .buildPerson("1", "Andre", "Silva", LocalDate.of(1988,6,25))
